...
{
    /// <inheritdoc />
    public partial class UpdateDbContextForMultiBranch : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CarMaintenanceHistories", x => x.HistoryId);
                    table.ForeignKey(
                        name: "FK_CarMaintenanceHistories_Branches_BranchId",
                        column: x => x.BranchId,
                        principalTable: "Branches",
                        principalColumn: "BranchId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CarMaintenanceHistories_Cars_CarId",
                        column: x => x.CarId,
                        principalTable: "Cars",
                        principalColumn: "CarId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CarReminders", x => x.ReminderId);
                    table.ForeignKey(
                        name: "FK_CarReminders_Branches_BranchId",
                        column: x => x.BranchId,
                        principalTable: "Branches",
                        principalColumn: "BranchId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CarReminders_Cars_CarId",
                        column: x => x.CarId,
                        principalTable: "Cars",
                        principalColumn: "CarId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CarMaintenanceHistories_BranchId",
                table: "CarMaintenanceHistories",
                column: "BranchId");

            migrationBuilder.CreateIndex(
                name: "IX_CarMaintenanceHistories_CarId",
                table: "CarMaintenanceHistories",
                column: "CarId");

            migrationBuilder.CreateIndex(
                name: "IX_CarReminders_BranchId",
                table: "CarReminders",
                column: "BranchId");

            migrationBuilder.CreateIndex(
                name: "IX_CarReminders_CarId",
                table: "CarReminders",
                column: "CarId");
